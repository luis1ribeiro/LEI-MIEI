 ...
 * @author xaLuG
 */
public class Reproduzir_Musica extends javax.swing.JFrame implements View {

    /**
     * Creates new form Reproduzir_Musica
     */
    public Reproduzir_Musica(Socket s,String nome, String artista, View v) {
        this.socket=s;
        this.nome=nome;
        this.artista=artista;
        this.tabela= (Musicas_Lista)v;
        initComponents();
    }
    ...
    private void CategoriaChangeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CategoriaChangeActionPerformed
        new MudarCategoria(this.socket,this.nome,this.artista,this.tabela).run();
