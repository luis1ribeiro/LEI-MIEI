...
public class Registar extends javax.swing.JFrame implements View {

    public Registar(Socket s) {
        initComponents();
        this.socket=s;
    }
    ...
    private void criarConta(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            pw.println("registarUtilizador?" +e + "?" +pwd+ "?" +user);
            pw.flush();
