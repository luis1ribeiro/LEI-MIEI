...
public class EditarConta extends javax.swing.JFrame implements View {

    public EditarConta(Socket s) {
        initComponents();
        this.socket=s;
    }
    ...
    private void voltaAtras(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new Inicio (this.socket).run();
        this.setVisible(false);
        dispose();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void editarConta(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            pw.println("editarConta?" +e + "?" +pwd+ "?" +user);
            pw.flush();
