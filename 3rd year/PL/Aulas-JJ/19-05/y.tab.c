...
{
  "$end", "error", "$undefined", "TSTR", "TINT", "LER", "ESCREVER", "VAR",
  "NUM", "STR", "'+'", "'-'", "'/'", "'*'", "'='", "';'", "'('", "')'",
  "$accept", "axioma", "decls", "prog", "state", "decl", "exp", YY_NULLPTR
};
#endif
...
{
       3,     0,     0,     1,     0,     0,     0,     0,     2,     6,
       4,     0,     0,    13,    12,    14,     0,     0,     0,     5,
      11,    10,     0,     0,     0,     0,     0,     9,     0,     0,
      19,    15,    16,    18,    17,     8,     7
};
...
#line 60 "compiler.y" /* yacc.c:1646  */
    {asprintf(&(yyval.ass), "pushi 0//%c",(yyvsp[-1].c)); 
                         _ad((yyvsp[-1].c)) = COUNT_VAR; 
                         _ty((yyvsp[-1].c)) = 1; 
                         COUNT_VAR++;}
...
#line 64 "compiler.y" /* yacc.c:1646  */
    {asprintf(&(yyval.ass), "pushs \"\" //%c",(yyvsp[-1].c)); 
                         _ad((yyvsp[-1].c)) = COUNT_VAR; 
                         _ty((yyvsp[-1].c)) = 2; 
                         COUNT_VAR++;}
